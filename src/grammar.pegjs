// Modified from https://github.com/pegjs/pegjs/blob/b7b87ea8aeeaa1caf096e2da99fd95a971890ca1/examples/css.pegjs
...
ConditionalLabel
  = label:comment S? qualifiers:(attrib)+ {
    return {
      label: label[1].join('').trim(),
      qualifiers
    };
  }
  / label:.+ {
